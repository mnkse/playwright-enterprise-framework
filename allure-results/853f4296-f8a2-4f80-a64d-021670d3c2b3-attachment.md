...
- Name: api\users.api.spec.ts >> Users API Tests >> should update a user
- Location: tests\api\users.api.spec.ts:69:7

# Error details

```
Error: apiRequestContext.put: getaddrinfo ENOTFOUND test-api.example.com
Call log:
  - → PUT https://test-api.example.com/users/1
