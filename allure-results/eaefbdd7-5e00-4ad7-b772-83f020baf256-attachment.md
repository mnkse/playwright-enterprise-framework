...
- Name: api\users.api.spec.ts >> Users API Tests >> should return 404 for non-existing user
- Location: tests\api\users.api.spec.ts:106:7

# Error details

```
Error: apiRequestContext.get: getaddrinfo ENOTFOUND test-api.example.com
Call log:
  - → GET https://test-api.example.com/users/999999
