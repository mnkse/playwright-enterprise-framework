...
- Name: api\users.api.spec.ts >> Users API Tests >> should delete a user
- Location: tests\api\users.api.spec.ts:95:7

# Error details

```
Error: apiRequestContext.delete: getaddrinfo ENOTFOUND test-api.example.com
Call log:
  - → DELETE https://test-api.example.com/users/1
